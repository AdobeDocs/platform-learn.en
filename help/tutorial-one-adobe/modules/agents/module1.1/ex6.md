...
Add yourself to the below group using IAM to get access to LLM credentials.

>[!NOTE]
>
>Some of the below instructions are specific to Adobe. Please ask your Adobe representative about the GRP to use.
...
>[!NOTE]
>
>The below commands require a specific URL to be used. Please ask your Adobe representative about the URL to use.
...
Verify that your instance is set to use instance **Experience Platform International** and sandbox **Accelerate**.
...
## 1.1.6.5 Correlate Orders with Content Preferences 
...
## 1.1.6.6 Identify Existing Fiber Journeys
...
## 1.1.6.7 Check which audience is used
...
## 1.1.6.8 Validate journey performance via fallout analysis 
...
Review the plan. Click **Accept plan**.
...
## 1.1.6.10 Find existing audiences aligned to high usage and check if they are in use
...
## 1.1.6.11 Create New Journey for Fiber Max Launch 
...
## 1.1.6.12 Journey Conflict Management
