---
title: Add a library
description: Learn how to create a tag library in Data Collection. This lesson is part of the Implement the Experience Cloud in Mobile Android™ Applications tutorial.
