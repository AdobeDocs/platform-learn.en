...
## 9.6.1 Create a new event in Journey Orchestration
...
## 9.6.2 Update your Adobe Experience Platform Data Collection Client property - Add To Cart Rule 
...
## 9.6.3 Create External Data Sources in Journey Orchestration for Offer Decisioning
...
## 9.6.4 Create a new journey in Journey Orchestration
