...
## 9.5.1 Work with the Offer Decisioning API using Postman
...
### 9.5.1.4 List Personalized Offers
...
### 9.5.1.7 Get Detailed Offers for Customer Profile
...
## 9.5.2 Use the Offer Decisioning API to showcase offers on Xray
...
### 9.5.2.1 [!UICONTROL Offer Decisioning Container ID]
...
### 9.5.2.2 [!UICONTROL Offer Decisioning Placement ID]
...
### 9.5.2.3 [!UICONTROL Offer Decisioning Decision ID]
...
### 9.5.2.4 Update your Enablement Configuration ID
...
### 9.5.2.1 Load website and brand
...
### 9.5.2.2 Customer browses the website
...
Next Step: [9.6 Test your Decision using Journey Orchestration](./ex6.md)
