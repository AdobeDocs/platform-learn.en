...
## 10.3.1 Create your order confirmation message
...
## 10.3.4 Use journey context in email message
...
## 10.3.5 Update your Adobe Experience Platform Data Collection Client property
...
You'll then see this. Navigate to the field **_experience.campaign.orchestration.eventID** and fill out your eventID here. The eventID to fill out here, is the eventID you created as part of exercise 10.3.2.
...
## 10.3.6 Test your order confirmation email using the demo website
...
Next Step: [10.4 Configure a batch-based newsletter journey](./ex4.md)
