...
This is an overview of the security features for the AI Assistant based on the <a href="https://www.adobe.com/cc-shared/assets/pdf/trust-center/ungated/whitepapers/experience-cloud/adobe-experience-platform-agent-orchestrator-security-overview.pdf">security fact sheet</a>.  For additional information, see the [AI Assistant privacy documentation](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/privacy).
