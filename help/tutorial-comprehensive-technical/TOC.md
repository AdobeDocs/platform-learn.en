...
+ 0 Getting started {#gettingstarted}
  + 0.1 Getting started {#gettingstarted}
    + [Overview](/help/tutorial-comprehensive-technical/modules/gettingstarted/getting-started.md)
    + [0.0.1 Install the Chrome extension for the Experience League documentation](/help/tutorial-comprehensive-technical/modules/gettingstarted/ex1.md)
    + [0.0.2 Use Demo System Next to setup your Adobe Experience Platform Data Collection client property](/help/tutorial-comprehensive-technical/modules/gettingstarted/ex2.md)
    + [0.0.3 Create your Datastream](/help/tutorial-comprehensive-technical/modules/gettingstarted/ex3.md)
    + [0.0.4 Use the website](/help/tutorial-comprehensive-technical/modules/gettingstarted/ex4.md)
    + [0.0.5 Use the mobile app](/help/tutorial-comprehensive-technical/modules/gettingstarted/ex5.md)

+ 1 Data Collection {#datacollection}
  + 1.1 Adobe Experience Platform Data Collection and the Web SDK extension {#module1.1}
  ...
  + 1.3 - Federated Audience Composiiton {#module1.3}
...
+ 2 Real-Time CDP B2C {#rtcdpb2c}  
  + 2.1 Real-time Customer Profile {#module2.1}
  ...
  + 2.2 Intelligent Services {#module2.2}
  ...
  + 2.3 Real-Time CDP: Build a segment and take action! {#module2.3}
  ...
  + 2.4 Real-Time CDP: Segment Activation to Microsoft Azure Event Hub {#module2.4}
  ...
  + 2.5 Real-Time CDP Connections: Event Forwarding{#module2.5}
  ...
  + 2.6 Stream data from Apache Kafka into Real-Time CDP {#module2.6}
...
+ 3 Adobe Journey Optimizer B2C {#ajob2c} 
  + 3.1 Adobe Journey Optimizer: Orchestration {#module3.1}
  ...
  + 3.2 Adobe Journey Optimizer: External data sources and custom actions {#module3.2}
  ...
  + 3.3 Adobe Journey Optimizer: Offer Decisioning {#module3.3}
  ...
  + 3.4 Adobe Journey Optimizer: Event-based Journeys {#module3.4}
...
+ 4 Customer Journey Analytics B2C {#cjab2c} 
  + 4.1 Customer Journey Analytics: Build a dashboard using Analysis Workspace on top of Adobe Experience Platform {#module4.1}
  ...
  + 4.2 Customer Journey Analytics: Ingest and Analyze Google Analytics data in Adobe Experience Platform with the BigQuery Source Connector {#module4.2}
