...
## 2.3.7.1 Setup your Adobe I/O Project
...
![Adobe I/O New Integration](../module2.1/images/iohome.png)
...
![Adobe I/O New Integration](../module2.1/images/adobe_io_new_integration.png) or 
![Adobe I/O New Integration](../module2.1/images/adobe_io_new_integration1.png)

Select **+ Add to Project** and select **API**.

![Adobe I/O New Integration](../module2.1/images/adobe_io_access_api.png)

You'll then see this:

![Adobe I/O New Integration](../module2.1/images/api1.png)

Click the **Adobe Experience Platform** icon.

![Adobe I/O New Integration](../module2.1/images/api2.png)

Click **Experience Platform API**.

![Adobe I/O New Integration](../module2.1/images/api3.png)

Click **Next**.

![Adobe I/O New Integration](../module2.1/images/next.png)
...
![Adobe I/O New Integration](../module2.1/images/api4.png)

Click **Generate keypair**.

![Adobe I/O New Integration](../module2.1/images/generate.png)

You'll see a spinner for about 30 seconds.

![Adobe I/O New Integration](../module2.1/images/spin.png)
...
![Adobe I/O New Integration](../module2.1/images/zip.png)
...
![Adobe I/O New Integration](../module2.1/images/config.png)
...
![Adobe I/O New Integration](../module2.1/images/api9.png)

Click **Save Configured API**.

![Adobe I/O New Integration](../module2.1/images/saveconfig.png)

You'll see a spinner for a couple of seconds.

![Adobe I/O New Integration](../module2.1/images/api10.png)

And next, you'll see your integration.

![Adobe I/O New Integration](../module2.1/images/api11.png)
...
![Adobe I/O New Integration](../module2.1/images/iopm.png)
...
![Adobe I/O New Integration](../module2.1/images/api12.png)
...
![Adobe I/O New Integration](../module2.1/images/api13.png)
...
![Adobe I/O New Integration](../module2.1/images/api16.png)

## 2.3.7.2 Postman authentication to Adobe I/O

Go to [https://www.getpostman.com/](https://www.getpostman.com/). 

Click on **Get Started**.

![Adobe I/O New Integration](../module2.1/images/getstarted.png)

Next, download and install Postman.

![Adobe I/O New Integration](../module2.1/images/downloadpostman.png)
...
![Adobe I/O New Integration](../module2.1/images/pmfolder.png)

Go back to Postman. Click **Import**.

![Adobe I/O New Integration](../module2.1/images/postmanui.png)

Click **Upload Files**.

![Adobe I/O New Integration](../module2.1/images/choosefiles.png)
...
![Adobe I/O New Integration](../module2.1/images/selectfiles.png)
...
![Adobe I/O New Integration](../module2.1/images/impconfirm.png)
...
## 2.3.7.3 Define endpoint and format
...
## 2.3.7.4 Create a server and template configuration
...
## 2.3.7.6 Link your segment to your destination
...
## 2.3.7.7 Test your segment activation
