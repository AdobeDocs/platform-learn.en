...
## 2.4.5.1 Getting familiar with Azure Event Hub functions
...
## 2.4.5.2 Open Visual Studio Code and Logon to Azure
...
## 2.4.5.3 Create an Azure Project
...
Next Step: [2.4.6 End-to-end scenario](./ex6.md)
