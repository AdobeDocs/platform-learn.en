...
Enter **luma-insurance-sales-propensity.ipynb** as the name for your notebook and hit **Enter**. You'll then have this:
...
>
>**aepCarInsuranceInteractionsDatasetId** refers to the dataset ID of the dataset **AEP Demo - Car Insurance Interactions**, **aepMlPredictionsDatasetId** refers to the dataset ID of the dataset **AEP Demo - ML Predications**, **aepMlPredictionsSchemaRef** refers to the Schema Ref ID of the schema **AEP Demo - ML Predications Schema**. Replace the environment variables by the dataset ID and Schema Ref ID when you paste the code in the **Scoring Configuration** cell in your notebook.
...
def load(config_properties):
    ...
    df1.loc[(df1['purchase'] == 'no'), 'purchase'] = 0
