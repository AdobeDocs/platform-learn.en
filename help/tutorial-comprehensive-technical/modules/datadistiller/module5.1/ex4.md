...
## 5.1.4.1 Create a dataset from a SQL query
...
Next Step - Option A: [5.1.5 Query Service and Power BI](./ex5.md)

Next Step - Option B: [5.1.6 Query Service and Tableau](./ex6.md)
