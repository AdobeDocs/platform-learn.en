...
doc-type: tutorial
---
# 5.1.3 Queries, queries, queries...  and churn analysis
...
## 5.1.3.1 Write basic queries for data analysis
...
Next Step: [5.1.4 Generate a dataset from a query](./ex4.md)
