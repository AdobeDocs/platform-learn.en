...
TQID: https://experienceleague.adobe.com/jEJvUaweBH8ktn8nalZFufUqdgaIJQRZlPuBdSY0CFQ
product_v2:
...
* add to cart: when a user taps ![ShoppingCart](/help/assets/icons/ShoppingCart.svg) in a product detail screen,
* save for later: when a user taps ![Heart](/help/assets/icons/Heart.svg) / ![ThumbUp](/help/assets/icons/ThumbUp.svg) in a product detail screen,
* purchase: when a user taps ![CreditCard](/help/assets/icons/CreditCard.svg) in a product detail screen.
...
1. Navigate to **[!DNL Luma]** > **[!DNL Luma]** > **[!DNL Views]** > **[!DNL Products]** > **[!UICONTROL ProductView]** in Xcode Project navigator and add various calls to the `sendCommerceExperienceEvent` function:
   ...
   1. For each of the buttons (![Heart](/help/assets/icons/Heart.svg), ![ShoppingCart](/help/assets/icons/ShoppingCart.svg), and ![CreditCard](/help/assets/icons/CreditCard.svg)) in the toolbar, add the relevant call within the `ATTrackingManager.trackingAuthorizationStatus == .authorized` closure:

      1. For ![Heart](/help/assets/icons/Heart.svg):
      ...
      1. For ![ShoppingCart](/help/assets/icons/ShoppingCart.svg):
      ...
      1. For ![CreditCard](/help/assets/icons/CreditCard.svg):
...
1. Navigate to **[!UICONTROL app]** > **[!UICONTROL kotlin+java]** > **[!UICONTROL com.adobe.luma.tutorial.android]** > **[!UICONTROL views]** > **[!UICONTROL ProductView.kt]** in the Android Studio navigator, and add various calls to the `sendCommerceExperienceEvent` function:
   ...
   1. For each of the buttons (![ThumbUp](/help/assets/icons/ThumbUp.svg), ![ShoppingCart](/help/assets/icons/ShoppingCart.svg), and ![CreditCard](/help/assets/icons/CreditCard.svg)) in the toolbar, add the relevant call within the `scope.launch` of the `if (MobileSDK.shared.trackingEnabled == TrackingStatus.AUTHORIZED)  statement`:

      1. For ![ThumbUp](/help/assets/icons/ThumbUp.svg):
...
1. Review the [setup instructions](assurance.md#connecting-to-a-session) section to connect your simulator or device with Assurance.
   ...
   1. Select a product.
   1. Select ![Heart](/help/assets/icons/Heart.svg) (iOS) or ![ThumbUp](/help/assets/icons/ThumbUp.svg) (Android).
   1. Select ![ShoppingCartAdd](/help/assets/icons/ShoppingCart.svg).
