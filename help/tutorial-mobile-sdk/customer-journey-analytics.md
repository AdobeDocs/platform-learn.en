...
1. In Connection settings, provide
   1. **[!UICONTROL Connection name]**, for example `Luma App - AEP Mobile SDK Tutorial Connection`.
   ...
   1. In the **[!UICONTROL Add datasets]** wizard, **[!UICONTROL Select datasets]** step, 
   ...
   1. In the **[!UICONTROL Add datasets]** wizard, **[!UICONTROL Datasets settings]** step, you need to define the Person ID for each of the event datasets. 
...
You have now defined your connection and Customer Journey Analytics will collect data from the datasets. This will take some time. 
...
In the **[!UICONTROL Connections]** > **[!UICONTROL Luma App - AEP Mobile SDK Tutorial Connection]**, you will see:
   
1. Information on total records added, records skipped, and records deleted. Ensure you select All datsets and select an appropriate time period to view details about your connection. You can use ![Calendar](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Calendar_18_N.svg) to open a dialog to select the time period.
...
After the records have been added from the datasets to Customer Journey Analytics, you can define a data view to define on which components of the data you want to report on. 
...
1. In **[!UICONTROL Data views >]** ensure the **[!UICONTROL Configure]** tab is selected.
...
1. In the **[!UICONTROL Components]** tab of the **[!UICONTROL Luma App - AEP Mobile SDK Tutorial Data view]**, you can define metrics and dimension you want to use when reporting on your mobile app. By default, a number of standard metrics and dimensions (jointly referred to a components) are already configured for your data view. To properly configure your data view you add more components. To add a schema field, from your previously defined schema or out of the box schemas (see [Create a schema](create-schema.md) lesson), as a component (dimension or metric):

   1. Find the schema field. You can do this by:

      - searching for the component using the ![Search](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Search_18_N.svg) ***[!UICONTROL Search schema fields]*** search field. For example, `productListAdd`, or

         ![CJA Dataview 2a](assets/cja-dataview-2a.png)

      - traversing down to the schema field within ![Folder](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Folder_18_N.svg) **[!UICONTROL Event datasets]** ![Chevron](https://spectrum.adobe.com/static/icons/ui_18/ChevronSize100.svg). <br/>For example ![Folder](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Folder_18_N.svg) **[!UICONTROL Event datasets]** ![Chevron](https://spectrum.adobe.com/static/icons/ui_18/ChevronSize100.svg) ![Folder](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Folder_18_N.svg) **[!UICONTROL commerce]** ![Chevron](https://spectrum.adobe.com/static/icons/ui_18/ChevronSize100.svg) ![Folder](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Folder_18_N.svg) **[!UICONTROL productListAdds]** ![Chevron](https://spectrum.adobe.com/static/icons/ui_18/ChevronSize100.svg)

        ![CJA Dataview 2a](assets/cja-dataview-2b.png)

   1. Drag the specific schema fields from the Schema fields pane to the **[!UICONTROL METRICS]** or **[!UICONTROL DIMENSIONS]** list in the [!UICONTROL Included components] pane.

      ![CJA Dataview 2a](assets/cja-dataview-3.png)

      Now you understand how to add schema fields to your data view, use the tables below for a list of schema fields to add as metric or dimension. Use the **Schema Path** column value from the table below to search for or traverse to the the specific schema field. Once dragged and dropped, check the **Component Settings** column value whether specific setting are required for a component, like modifying its **[!UICONTROL Component Name]** or defining **[!UICONTROL INCLUDE EXCLUDE VALUES]**. <br/>To specify settings for a component:

      1. Select a component.
      1. Modify any of the indicated settings for in the right pane.
      ...
      **METRICS**
      ...
      After you have added all schema fields from the table above as a metric component, your data view configuration for METRICS should look like:
      ...
      **DIMENSIONS**
      ...
      After you have added all schema fields from the table above as a dimension component, your data view configuration for DIMENSIONS should look like:

      ![CJA Dataview 4](assets/cja-dataview-5.png)

   1. Select **[!UICONTROL Save and continue]**.

1. In the **[!UICONTROL Settings]** tab of the **[!UICONTROL Luma App - AEP Mobile SDK Tutorial Data view]** you can configure filters and session settings. For this tutorial, no additional configuration is required.

   - Select **[!UICONTROL Save and finish]**.

You have now defined your data view and everyting is in place to start building your reports and visualizations.

## Create a project

You use Workspace projects in Customer Journey Analytics to build your reports and visualizations. There are many possibilities to build comprehensive reports and engaging visualizations, but again this is outside the scope of this tutorial. See 

In this section of the lesson you will create a project that shows reports and visualizations on:
...
1. Select **[!UICONTROL Create project]**.
   ...
   1. Select **[!UICONTROL Blank Workspace project]** from the Analysis Workspace section.

      ![CJA Projects - 1](assets/cja-projects-1.png)

   1. Select **[!UICONTROL Create]**.

1. You are presented with the New project interface. In this interface you will build your reports and visualizations.

1. Select the name of the project and provide your own name for the project. For example `Luma App - AEP Mobile SDK Tutorial Project`.
...
1. In the Save dialog, ignore all other fields and select Save.
   ![CJA Project 4](assets/cja-projects-4.png)


>[!IMPORTANT]
>
>   Remember to save your project regularly, otherwise your changes will be lost. You can quickly save your project using **[!UICONTROL ctrl+s]** on Windows or **[!UICONTROL cmd+s]** on Mac OS. 

You have now set up our project. You already have a Freeform panel on your main canvas, containing a Freeform table. You will add components to this table soon, but you first have to ensure your Freeform panel is using the correct data view and the correct time period.
...
1. To define the appropriate time period for the panel, select This month and in the popup panel define start and end date, or use a Preset, like Last 6 full months and select Apply.
...
You first want to report on what screens viewed in the app.

1. Rename your Freeform panel to App Usage.
   
1. Rename your Freeform table to Screen Names.

1. Select Show all underneath the METRICS list.

1. Drag and drop the Screen Views component on Drop a metric here (or any other component).
   ![CJA Projects 7](assets/cja-projects-7.png)
   Your freeform table will now show screen views for the days for your selected time period. However, we want to show screen views for the different screens used in the app.

1. To show the Dimensions list of components, select ![Cross](https://spectrum.adobe.com/static/icons/ui_18/CrossSize100.svg) to remove the ![Event](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Event_18_N.svg) Metrics filter from the components rail.
   ![CJA Project 8](assets/cja-projects-8.png)

1. Select Show all underneath the DIMENSIONS list.

1. Drag and drop the Screen Name component on the Day header. The operation will show ![Switch](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Switch_18_N.svg) Replace to indicate the replacement of the dimension.
   ![CJA Projects 9](assets/cja-projects-9.png)

Your first report is ready; showing you screen views for the various screen names you defined in the app.
...
1. Select ![Add](https://spectrum.adobe.com/static/icons/workflow_18/Smock_AddCircle_18_N.svg) and from the popup Freeform table to add a new ![Freeform table](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Table_18_N.svg) Freeform table.
   ![CJA Projects 11](assets/cja-projects-11.png)

1. Rename Freeform table (2) to App Interactions.

1. Drag and drop the App Interactions metric on Drop a metric here (or any other component).

1. Drag and drop the App Interaction Name dimension on the Day header to replace this dimension.

Your second report is now ready, showing app interactions. 
![CJA Projects 12](assets/cja-projects-12.png)

The information is limited mainly because you implemented limited `MobileSDK.shared.sendAppInteractionEvent(actionName: "<actionName>")` API calls. If you add more of these API calls into your app, this report becomes more informative.
...
You now want to report on commerce events happening in the app. You will do this in a separate panel.

#### Commerce Events

1. Select ![Add](https://spectrum.adobe.com/static/icons/workflow_18/Smock_AddCircle_18_N.svg) outside of the current App Usage panel, to create a new panel.
...
1. Rename Panel to Commerce.

1. Rename Freeform table to Commerce Events.

1. Drag and drop Product Views metric to Drop a metric here (or any other component).

1. Drag and drop Product Add To Lists metric to the right of the Product Views column to insert this column in the freeform table. Ensure **[!UICONTROL + Add]** in blue is shown when inserting the column.
   ![CJA Projects 15](assets/cja-projects-15.png)

1. Repeat previous step to add the Save For Laters metric and the Purchases metric to the freeform table.

1. Drag and drop the Month dimension on top of the Day dimension to change the reporting from daily to monthly.

Your Commerce Events report is now ready, showing how users looked at products, added products to their wish list, saved products for later or even purchased your products.
...
1. Select ![Add](https://spectrum.adobe.com/static/icons/workflow_18/Smock_AddCircle_18_N.svg) within the Commerce panel and from the popup select ![Fallout](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ConversionFunnel_18_N.svg) Fallout.

1. Select Product Views from the Add touchpoint dropdown list.
   ![CJA Projects 18](assets/cja-projects-18.png) 
   Alternatively, you can drag and drop the Products View dimension underneath the All people dimension in the Fallout visualization.

1. Repeat the above step for Product Add To Lists and Purchases. You Fallout visualization now shows a visual representation of the conversion funnel for your products.
...
You want to report on how many offers are displayed to your users and what offers were displayed to them.
...
1. Rename the Panel to Offers

1. Rename the Freeform table to Monthly Overview.

1. Drag and drop the Display metric on to Drop a metric here (or any other component).

1. Drag and drop the Month dimension on the Day column to replace the dimension.

You now do have a report showing the offers displayed to your users in the app.
...
1. Select ![Add](https://spectrum.adobe.com/static/icons/workflow_18/Smock_AddCircle_18_N.svg) within the Offers panel and Freeform table from the popup to add a new ![Freeform table](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Table_18_N.svg) Freeform table.

1. Rename Freeform table (2) to People.

1. Drag and drop the People metric on to Drop a metric here (or any other component).

1. Drag and drop the Activity Name on the Day column to replace the dimension.

1. Right-click on the a row, identifying one or more of the offer decisions you defined in the [Create and display offers with Decision Management](journey-optimizer-offers.md) lesson. For example, Luma - Mobile App Decision.

1. From the context menu select Breakdown > Dimensions > Offer Name. This will breakdown the Activity Name dimension for Offer Names. 

A a result you now have a report showing the individual offers displayed for the selected period to users of your app as part of this offer decision.
...
1. Rename Freeform table to Store Entries / Exits Across Cities.

1. Drag and drop the Location Events metric on to Drop a metric here (or any other component). This will show a daily overview of all the location events that occurred in the app. Remember how we specifically configured this dimension as part of our [data view](#create-a-data-view).

1. Drag and drop the City dimension on the Day column header to replace the dimension. The report now shows the cities for the location events. 

1. To remove geolocation events with no cities associated to it, select ![Filter](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Filter_18_N.svg) and from the Search popup uncheck Include "No value", then select Apply.

   ![CJA Projects 22](assets/cja-projects-22.png)

   This removes the No value row from the report.

1. Select all rows in the table, right-click and from the context menu select Breakdown > Dimension > Event Types.

You now do have a report showing users being in and out of the vicinity of your store locations (as you defined these locations in the [Places](places.md) lesson).

![CJA Project 23](assets/cja-projects-23.png)

## Next steps

You should now have a basic understanding how to report and visualize on your mobile app usage, interactions, and more using Customer Journey Analytics.
