...
seo-title: Build audiences | Getting Started with Adobe Experience Platform for Data Architects and Data Engineers
breadcrumb-title: Build audiences
description: In this lesson, we will build audiences based on the profile data we have ingested in the previous lessons.
role: Developer
feature: Data Governance
jira: KT-4348
thumbnail: 4348-build-segments.jpg
exl-id: cd05e814-1ea7-48ba-adf6-1a71504c623e
TQID: https://experienceleague.adobe.com/Cevg1MvW7bx4z1hU81WWLW2J5ES7rU5aPuJmGV-JTek
product_v2:
...
**Data Architects** will need to create audiences outside of this tutorial and support their colleagues with this task.

Before you begin the exercises, watch this short video to learn more about creating audiences:
...
Let's create a simple audience for loyalty program customers with a Gold or Platinum Status

1. In the Platform user interface, go to **[!UICONTROL Audiences]** in the left navigation
1. Select the **[!UICONTROL Create audience]** button 
1. Select **[!UICONTROL Build rule]** and then **[!UICONTROL Create]**
1. On the left of the schema builder are three tabs for Attributes (Record data), Events (Time-series data), and Audiences
1. Select the gear icon to note how the audience builder defaults to only show you fields with data and allows you to change the merge policy
1. In Attributes tab, navigate to the **XDM Individual Profile > Loyalty** folder (you could also search for "loyalty")
1. Drag and drop, `Tier` from the attribute fields menu to the audience builder canvas 
...
In this exercise, we will create an audience for customers who have bought the same product twice within 30 days. Dynamic segments allow you to scale your segmentation by using fields as variables.

1. Go to **[!UICONTROL Audiences]** in the left navigation
1. Select the **[!UICONTROL Create audience]** button 
1. Select **[!UICONTROL Build rule]** and then **[!UICONTROL Create]**
...
1. Confirm that your audience definition at this point reads **"Include audience who have at least 1 Purchases event then within 30 days have at least 1 Purchases event"**
...
1. Name your audience `Bought same product within 30 days`
...
1. Select the **[!UICONTROL Publish]** button
...
With the advanced multi-entity segmentation feature, you can create segments using multiple XDM classes to extend your schemas. As a result, the audience builder can access additional fields as if they were native to the profile data store

You will create the next audience by applying the relationship you built between your `Luma Product Catalog Schema` and your `Luma Offline Purchase Events Schema`.
...
## Batch and Streaming audiences

Click on **[!UICONTROL Audiences]** in the left navigation and let's take a moment to review our three audiences:

* Two of our audiences are batch audiences and one is a streaming segment. 
* Platform defaults to streaming segmentation whenever possible, qualifying the customer for an audience as soon as they meet the criteria. When audience definitions are too complex for streaming, they will automatically convert to batch. In this case, the two audiences defaulted to batch because the look-back window of the purchase events was greater than seven days. For a complete and current list of streaming limitations, see [the documentation](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/streaming-segmentation.html).
...
There is more to segmentation, especially with activating audiences. Those topics will be addressed in another tutorial.
