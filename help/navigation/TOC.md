...
+ Customer Journey Analytics {#cja}
  ...
  + [Connecting to Data Sources in Platform](/help/cja/connecting-customer-journey-analytics-to-data-sources-in-platform.md)
...
+ Data Ingestion{#data-ingestion}
  + [Understanding Data Ingestion](/help/datasets/understanding-data-ingestion.md)
  + [Understanding Streaming Ingestion](/help/datasets/understanding-streaming-ingestion.md)
  + [Create Datasets and Ingest Data](/help/datasets/create-datasets-and-ingest-data.md)
  + [Understanding Source Connectors](/help/datasets/understanding-source-connectors.md)
  + [Ingest Data from Adobe Analytics](/help/datasets/ingest-data-from-adobe-analytics.md)
  + [Ingest Data from Amazon S3](/help/datasets/ingest-data-from-amazon-s3.md)
  + [Ingest Data from Salesforce CRM](/help/datasets/ingest-data-from-salesforce-crm.md)
...
+ Profiles{#profiles}
  + [Understanding the Real-time Customer Profile](/help/profiles/understanding-the-real-time-customer-profile.md)
  + [Bring Data into Unified Profile](/help/profiles/bring-data-into-the-real-time-customer-profile.md)
+ Segments{#segments}
...
+ [Getting Started with Platform for Data Architects and Data Engineers](/help/tutorial-data-architect-and-engineer/overview.md)