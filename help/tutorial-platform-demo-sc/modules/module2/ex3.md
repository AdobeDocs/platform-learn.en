...
#### Exercise 3.1 - Setup your Adobe IO Project
...
#### Exercise 3.3 - Postman authentication to Adobe I/O
...
You'll then see this. All fields are prepopulated, except for the field ``PRIVATE_KEY``.

![Postman](./images/pk2.png)

The private key has been generated when you created your Adobe IO Project. It was downloaded as a zipfile, named ``config.zip``. Extract that zip-file to your desktop.
