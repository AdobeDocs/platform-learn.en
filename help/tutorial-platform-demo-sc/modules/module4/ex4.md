...
The goal of this is to get to know the standard path to demo the AEP Demo-environment including the Alexa skill that you just built, and to use the below demo script in combination with the personalized demo website that you built in Module 3.
