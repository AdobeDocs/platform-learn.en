...
1. In the **Search or select profiles** dropdown appears, select the **Default Production All Access,** and **Sandbox Administrators** profiles:

   ![alt_text](assets/image002.png)

1. Click **Save** to save the user. You'll be redirected back to the Overview page. You should then receive an email indicating that you've received access to Adobe Experience Platform
...
1. Click into the only product profile available to you. Next, click the **Add User** button and select yourself as a user. Once added, you'll be redirected back to the product profile page.
1. Click on the **Permissions** tab. If you can see that the permission look like this…:
...
1. If you’re in the correct Experience Cloud Org, you should have access to **Experience Platform, Launch, Admin Tool, Admin console,** and a few other Adobe Services:

   ![alt_text](assets/image004.png)


1. Click the **Launch** icon followed by the blue **Go to Launch** button
...
1. Click on the **Solution Switcher** and select **Experience Platform.** You'll be redirected to platform.adobe.com. You should now see the Experience Platform Home screen.
...
5. In the **Configure profile** screen, find the Sandbox that you just created (and ONLY your sandbox) in the list and click on the **+** sign next to it in order to add it to the profile. 
...
9. On the next screen, add your user to the profile then click **Save**:
