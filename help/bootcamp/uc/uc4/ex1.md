...
## 4.1.1 What is Customer Journey Analytics?
...
## 4.1.3 Why choose Customer Journey Analytics?
...
## 4.1.4 Understand the Customer Journey Analytics workflow
...
## 4.1.5 Step 0: Understanding Adobe Experience Platform schemas and datasets
...
Before you continue, you need to select a **sandbox**. The sandbox to select is named ``Bootcamp``. You can do this by clicking the text **[!UICONTROL Prod]** in the top right corner of your screen. After selecting the appropriate sandbox, you'll see the screen change and now you're in your dedicated sandbox.
...
Next Step: [4.2 Connect Adobe Experience Platform Datasets in Customer Journey Analytics](./ex2.md)
